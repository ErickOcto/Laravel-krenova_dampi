    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                Daftar Kategori Fasilitas yang ada di sistem
            </div>
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center justify-content-center grid gap-2">
                                    ...
                                    <form onsubmit="return confirm('Apakah anda yakin?')" action="{{ route('category-facility.destroy', $category->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
