                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" action="{{ route('poverty.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="first-name-column">Nama Kepala Keluarga</label>
                                            <input type="text" id="first-name-column" name="name" class="form-control" placeholder="Masukkan Nama Penduduk">
                                        </div>
                                        @error('name')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" name="nik" class="form-control" placeholder="Masukkan NIK">
                                        </div>
                                        @error('nik')
                                            <strong class="alert alert-danger">{{ $message }}</strong>
                                        @enderror
                                    ...
                                    <div class="col-md-4 col-8">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="tanggal-lahir-column" name="birth_date" class="form-control" placeholder="Masukkan Tanggal Lahir">
                                        </div>
                                        @error('tanggal_lahir')
                                            <strong class="alert alert-danger">{{ $message }}</strong>
                                        @enderror
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="input-group">
                                            <input type="number" id="first-name-column" name="total_dependents" class="form-control" placeholder="Masukkan Jumlah Tanggungan" aria-describedby="basic-addon1">
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="input-group">
                                            <input type="number" id="first-name-column" name="total_familymember" class="form-control" placeholder="Masukkan Jumlah Seluruh Anggota Keluarga" aria-describedby="basic-addon1">
                                    ...
                                    <div class="col-md-3 col-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" id="first-name-column" name="wide_area" class="form-control" placeholder="Masukkan Ukuran Luas Tanah" aria-describedby="basic-addon1" oninput="formatRupiah(this)">
                                    ...
                                    <div class="col-md-3 col-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" id="first-name-column" name="size_house" class="form-control" placeholder="Masukkan Ukuran Luas Rumah" aria-describedby="basic-addon1" oninput="formatRupiah(this)">
                                            <span class="input-group-text" id="basic-addon1">m²</span>
                                    ...
                                    <div class="col-md-3 col-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" id="first-name-column" name="totalbedroom" class="form-control" placeholder="Masukkan Jumlah Kamar Tidur" aria-describedby="basic-addon1" oninput="formatRupiah(this)">
